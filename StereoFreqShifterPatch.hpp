...
name: "Stereo Frequency Shifter"
version: "0.1"
Code generated with Faust 2.0.a41 (http://faust.grame.fr)
------------------------------------------------------------ */

#ifndef  __StereoFreqShifter_H__
#define  __StereoFreqShifter_H__
/************************************************************************
...
class StereoFreqShifter : public dsp {
  ...
  public:
	...
	void static metadata(Meta* m) { 
		...
		m->declare("name", "Stereo Frequency Shifter");
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addHorizontalSlider("L-R Offset", &fHslider3, 0.f, 0.f, 1.f, 1e-05f);
		...
		interface->addHorizontalSlider("Shift", &fHslider1, 0.f, -1.f, 1.f, 0.001f);
		interface->closeBox();
...
public:
    ...
    StereoFreqShifterPatch() : fUI(this)
    {
