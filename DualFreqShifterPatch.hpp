...
#ifndef  __DualFreqShifter_H__
#define  __DualFreqShifter_H__
/************************************************************************
...
#ifndef __DualFreqShifterPatch_h__
#define __DualFreqShifterPatch_h__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS DualFreqShifter
#endif

class DualFreqShifter : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addHorizontalSlider("Shift L", &fHslider1, 0.f, -1.f, 1.f, 0.001f);
		interface->declare(&fHslider3, "OWL", "PARAMETER_B");
		interface->declare(&fHslider3, "unit", "hz");
		interface->addHorizontalSlider("Shift R", &fHslider3, 0.f, -1.f, 1.f, 0.001f);
		interface->declare(&fHslider2, "OWL", "PARAMETER_C");
		interface->addHorizontalSlider("Shift Scalar", &fHslider2, 1.f, 1.f, 100.f, 0.1f);
		interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow2 = (fConst3 * (float(fHslider1) * fSlow1));
		float fSlow3 = (fConst3 * (fSlow1 * float(fHslider3)));
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp5 = (fRec3[1] + fSlow2);
			fRec3[0] = (fTemp5 - floorf(fTemp5));
			float fTemp6 = (6.28319f * fmodf(fRec3[0], 1.f));
			float fTemp7 = (1.94632f * fRec5[1]);
			fRec5[0] = ((fTemp0 + fTemp7) - (0.94657f * fRec5[2]));
			float fTemp8 = (0.83774f * fRec4[1]);
			fRec4[0] = ((fRec5[2] + ((0.94657f * fRec5[0]) + fTemp8)) - ((0.06338f * fRec4[2]) + fTemp7));
			output0[i] = FAUSTFLOAT(((fTemp0 * fTemp2) + (fRec0[0] * (((((0.870686f * fRec1[0]) + fRec1[2]) - fTemp4) * cosf(fTemp6)) - (sinf(fTemp6) * (((0.06338f * fRec4[0]) + fRec4[2]) - fTemp8))))));
			float fTemp9 = (0.02569f * fRec7[1]);
			fRec7[0] = ((fTemp1 + (0.260502f * fRec7[2])) - fTemp9);
			float fTemp10 = (1.8685f * fRec6[1]);
			fRec6[0] = ((fRec7[2] + (fTemp10 + fTemp9)) - ((0.870686f * fRec6[2]) + (0.260502f * fRec7[0])));
			float fTemp11 = (fRec8[1] + fSlow3);
			fRec8[0] = (fTemp11 - floorf(fTemp11));
			float fTemp12 = (6.28319f * fmodf(fRec8[0], 1.f));
			float fTemp13 = (1.94632f * fRec10[1]);
			fRec10[0] = ((fTemp1 + fTemp13) - (0.94657f * fRec10[2]));
			float fTemp14 = (0.83774f * fRec9[1]);
			fRec9[0] = ((fRec10[2] + ((0.94657f * fRec10[0]) + fTemp14)) - ((0.06338f * fRec9[2]) + fTemp13));
			output1[i] = FAUSTFLOAT(((fTemp1 * fTemp2) + (fRec0[0] * (((((0.870686f * fRec6[0]) + fRec6[2]) - fTemp10) * cosf(fTemp12)) - (sinf(fTemp12) * (((0.06338f * fRec9[0]) + fRec9[2]) - fTemp14))))));
			fRec0[1] = fRec0[0];
			fRec2[2] = fRec2[1];
			fRec2[1] = fRec2[0];
			fRec1[2] = fRec1[1];
...
/**************************************************************************************
	...
	DualFreqShifterPatch : an OWL patch that calls Faust generated DSP code
	
***************************************************************************************/

class DualFreqShifterPatch : public Patch
{
    DualFreqShifter   fDSP;
    OwlUI	fUI;
    
public:

    DualFreqShifterPatch() : fUI(this)
    {
...
#endif // __DualFreqShifterPatch_h__
